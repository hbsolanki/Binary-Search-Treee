...
public class BST {
    ...
    // inOrderSuccessor->Left Most Node in RightSubTree
    ...
    // Diameter O(N^2) : No. of nodes in the longest path between 2 leaves
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    break;
                case 2:
                    System.out.print("Enter Value That You Want To Search :");
                    ...
                    break;
                case 3:
                    System.out.print("Enter Value That You Want To Delete :");
                    int dele = sc.nextInt();
                    if (search(root, dele)) {
                        delete(root, dele);
                    ...
                    break;
                case 4:
                    System.out.println("Total Nodes is : " + countOfNodes(root));
                    ;
                    break;
                case 5:
                    ...
                    break;
                case 6:
                    System.out.println("Diammeter of Tree is : " + diameter(root));
                    break;
                case 7:
                    System.out.println("Sum of All Nodes value is : " + sumOfNodes(root));
                    break;
                case 8:
